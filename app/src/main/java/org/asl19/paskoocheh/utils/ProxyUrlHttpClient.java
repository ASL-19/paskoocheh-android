...
/*
 * ASL19: Note, this is a copy of the com.amazon.aws.http.UrlHttpClient. The original
 * ignored the proxy settings from the ClientConfiguration.
 */
 ...
 */
public class ProxyUrlHttpClient implements HttpClient {

    private static final String TAG = "amazonaws";
    private static final Log log = LogFactory.getLog(ProxyUrlHttpClient.class);
     ...
     */
    public ProxyUrlHttpClient(ClientConfiguration config) {
        this.config = config;
